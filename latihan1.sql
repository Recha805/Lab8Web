...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.3&nocache=6274374691ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.0.3" media="print" id="printcss">
    <title>localhost / 127.0.0.1 / latihan1 | phpMyAdmin 5.0.3</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&amp;v=5.0.3"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/database/structure.js?v=5.0.3"></script>
  <script data-cfasync="false" type="text/javascript" src="js/table/change.js?v=5.0.3"></script>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"db_structure.php",lang:"en",server:"1",table:"",db:"latihan1",token:"4b66636d2c6b795b40346b30783d3653",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.0.3",auth_type:"config",user:"root"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="tbl_recent_favorite.php?db=latihan1&amp;table=data_barang">`latihan1`.`data_barang`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=recha_311910257&amp;table=mahasiswa_311910257">`recha_311910257`.`mahasiswa_311910257`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=monica_311910190&amp;table=mahasiswa_311910190">`monica_311910190`.`mahasiswa_311910190`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=recha_311910257&amp;table=barang">`recha_311910257`.`barang`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=monica_311910190&amp;table=pengembalian">`monica_311910190`.`pengembalian`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=monica_311910190&amp;table=peminjaman">`monica_311910190`.`peminjaman`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=monica_311910190&amp;table=buku">`monica_311910190`.`buku`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=monica_311910190&amp;table=anggota">`monica_311910190`.`anggota`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=monica_311910190&amp;table=tb_siswa">`monica_311910190`.`tb_siswa`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=rechairfan_311910257&amp;table=pengembalian">`rechairfan_311910257`.`pengembalian`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class='block '><a href='server_databases.php?server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='server_databases.php?server=1' title='New'>New</a><div class="clearfloat"></div></li><li class="navGroup"><div class='block'><i></i><b></b><a class="expander loaded container" href='#'><span class='hide aPath'>cm9vdA==</span><span class='hide vPath'>cm9vdA==.ZGI=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><i><div class='block '><u><img src="themes/dot.gif" title="Groups" alt="Groups" class="icon ic_b_group"></u></div>&nbsp;db</i><div class="clearfloat"></div><div style='display: none;' class='list_container'><ul><li class="database database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.ZGJfbnVudWs=</span><span class='hide vPath'>cm9vdA==.ZGI=.bnVudWs=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=db_nunuk&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=db_nunuk' title='Structure'>db_nunuk</a><div class="clearfloat"></div></li><li class="database last database"><div class='block'><i></i><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.ZGJfc2hvd3Jvb20=</span><span class='hide vPath'>cm9vdA==.ZGI=.c2hvd3Jvb20=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=db_showroom&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=db_showroom' title='Structure'>db_showroom</a><div class="clearfloat"></div></li></ul></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.ZGIt</span><span class='hide vPath'>cm9vdA==.ZGIt</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=db-&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=db-' title='Structure'>db-</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h</span><span class='hide vPath'>cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=information_schema' title='Structure'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.bGF0aWhhbjE=</span><span class='hide vPath'>cm9vdA==.bGF0aWhhbjE=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=latihan1&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=latihan1' title='Structure'>latihan1</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.bW9uaWNhXzMxMTkxMDE5MA==</span><span class='hide vPath'>cm9vdA==.bW9uaWNhXzMxMTkxMDE5MA==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=monica_311910190&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=monica_311910190' title='Structure'>monica_311910190</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.bXlzcWw=</span><span class='hide vPath'>cm9vdA==.bXlzcWw=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=mysql' title='Structure'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h</span><span class='hide vPath'>cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=performance_schema' title='Structure'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cGhwbXlhZG1pbg==</span><span class='hide vPath'>cm9vdA==.cGhwbXlhZG1pbg==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=phpmyadmin' title='Structure'>phpmyadmin</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cmVjaGFpcmZhbnRyaWppYW50b18zMTE5MTAyNTdfa2VsYXNfdGkxOWIyX21hdGt1bF9iYXNpc2RhdGE=</span><span class='hide vPath'>cm9vdA==.cmVjaGFpcmZhbnRyaWppYW50b18zMTE5MTAyNTdfa2VsYXNfdGkxOWIyX21hdGt1bF9iYXNpc2RhdGE=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=rechairfantrijianto_311910257_kelas_ti19b2_matkul_basisdata&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=rechairfantrijianto_311910257_kelas_ti19b2_matkul_basisdata' title='Structure'>rechairfantrijianto_311910257_kelas_ti19b2_matkul_basisdata</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cmVjaGFpcmZhbl8zMTE5MTAyNTc=</span><span class='hide vPath'>cm9vdA==.cmVjaGFpcmZhbl8zMTE5MTAyNTc=</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=rechairfan_311910257&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=rechairfan_311910257' title='Structure'>rechairfan_311910257</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cmVjaGFfMzExOTEwMjU3</span><span class='hide vPath'>cm9vdA==.cmVjaGFfMzExOTEwMjU3</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=recha_311910257&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=recha_311910257' title='Structure'>recha_311910257</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.cmVudGFsX21vYmls</span><span class='hide vPath'>cm9vdA==.cmVudGFsX21vYmls</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=rental_mobil&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=rental_mobil' title='Structure'>rental_mobil</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class='hide aPath'>cm9vdA==.dGVzdA==</span><span class='hide vPath'>cm9vdA==.dGVzdA==</span><span class='hide pos'>0</span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class='block '><a href='db_operations.php?server=1&amp;db=test&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='db_structure.php?server=1&amp;db=test' title='Structure'>test</a><div class="clearfloat"></div></li>
  </ul>
</div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="db_structure.php?db=latihan1&amp;table=&amp;server=1&amp;target=" class="config-form disableAjax"><input type="hidden" name="tab_hash" value=""><input type="hidden" name="token" value="4b66636d2c6b795b40346b30783d3653">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="223"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="latihan1" targettable="data_barang">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `data_barang`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan1" targettable="data_barang">
                            <div class="action_content">
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="db_structure.php?db=latihan1&amp;table=&amp;server=1&amp;target=" class="config-form disableAjax"><input type="hidden" name="tab_hash" value=""><input type="hidden" name="check_page_refresh"  id="check_page_refresh" value="">
<input type="hidden" name="token" value="4b66636d2c6b795b40346b30783d3653">
<input type="hidden" name="submit_save" value="DbStructure"><ul class="tabs responsivetable">
...
<input type="hidden" name="db" value="latihan1"><input type="hidden" name="token" value="4b66636d2c6b795b40346b30783d3653">
<div class="responsivetable">
<table id="structureTable" class="data">
    <thead>
        <tr>
            <th class="print_ignore"></th>
            <th><a href="db_structure.php?db=latihan1&amp;pos=0&amp;sort=table&amp;sort_order=DESC" title="Sort" onmouseover="$('.sort_arrow').toggle();" onmouseout="$('.sort_arrow').toggle();">Table <img src="themes/dot.gif" title="" alt="Ascending" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Descending" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="print_ignore">
                Action            </th>
                        <th>
                <a href="db_structure.php?db=latihan1&amp;pos=0&amp;sort=records&amp;sort_order=DESC" title="Sort">Rows</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="db_structure.php?db=latihan1&amp;pos=0&amp;sort=type&amp;sort_order=ASC" title="Sort">Type</a></th>
                <th><a href="db_structure.php?db=latihan1&amp;pos=0&amp;sort=collation&amp;sort_order=ASC" title="Sort">Collation</a></th>
            
                                            <th><a href="db_structure.php?db=latihan1&amp;pos=0&amp;sort=size&amp;sort_order=DESC" title="Sort">Size</a></th>
                                <th><a href="db_structure.php?db=latihan1&amp;pos=0&amp;sort=overhead&amp;sort_order=DESC" title="Sort">Overhead</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="DATA_BARANG">
    ...
    <th>
        <a href="sql.php?db=latihan1&amp;table=data_barang&amp;pos=0" title="">
            data_barang
        </a>
                ...
                <td class="center print_ignore">
                                    <a id="f13b92973b8c8cac812087ffd4e0e1ac_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="db_structure.php?db=latihan1&amp;ajax_request=1&amp;favorite_table=data_barang&amp;add_favorite=1"
    title="Add to Favorites"
    data-favtargets="4dd696a22dcbc1ae1034c968084a72d1" >
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="center print_ignore">
        <a href="sql.php?db=latihan1&amp;table=data_barang&amp;pos=0">
            <span class="nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>

    </td>
    <td class="center print_ignore">
        <a href="tbl_structure.php?db=latihan1&amp;table=data_barang">
            <span class="nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="center print_ignore">
        <a href="tbl_select.php?db=latihan1&amp;table=data_barang">
            ...
            <a href="tbl_change.php?db=latihan1&amp;table=data_barang"><span class="nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="center print_ignore">
                <a class="truncate_table_anchor ajax" href="sql.php" data-post="?db=latihan1&amp;table=data_barang&amp;sql_query=TRUNCATE+%60data_barang%60&amp;message_to_show=Table+data_barang+has+been+emptied.">
            ...
            <a class="ajax drop_table_anchor"
                href="sql.php" data-post="?db=latihan1&amp;table=data_barang&amp;reload=1&amp;purge=1&amp;sql_query=DROP%20TABLE%20%60data_barang%60&amp;message_to_show=Table%20data_barang%20has%20been%20dropped.">
            ...
            data-table="data_barang">
                ...
                <a href="tbl_structure.php?db=latihan1&amp;table=data_barang#showusage">
...
<tr>
    ...
    <th class="tbl_num nowrap">
        ...
        <th>
                    ...
                    utf8mb4_general_ci
                                    ...
                                    <th class="value tbl_size">16.0 KiB</th>
  ...
  <p class="print_ignore">
    ...
    <a href="db_datadict.php?db=latihan1&amp;goto=db_structure.php" target="print_view">
  ...
  <div id="selflink" class="print_ignore"><a href="db_structure.php?db=latihan1&amp;table=&amp;server=1&amp;target=" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer"><img src="themes/dot.gif" title="Open new phpMyAdmin window" alt="Open new phpMyAdmin window" class="icon ic_window-new"></a></div>
